...
makePlot(DF1, "30 Most Common Unigrams")

makePlot(DF2, "30 Most Common Bigrams")

makePlot(DF3, "30 Most Common Trigrams")
...
# save R files and write csv files
save(DF1, file = "unigram.Rda")
save(DF2, file = "bigram.Rda")
save(DF3, file = "trigram.Rda")
save(DF4, file = "quadrigram.Rda")
save(DF5, file = "fivegram.Rda")

write.csv(DF1,"./unigram.csv",row.names=F)
write.csv(DF2,"./bigram.csv",row.names=F)
write.csv(DF3,"./trigram.csv",row.names=F)
write.csv(DF4,"./quadrigram.csv",row.names=F)
write.csv(DF5,"./fivegram.csv",row.names=F)
